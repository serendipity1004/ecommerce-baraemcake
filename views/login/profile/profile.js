...
jQuery(document).ready(function ($) {
    ...
    var table = $('#payment-info-datatable').DataTable({
        ...
        "columns": [{
            ...
            "data": null,
            "defaultContent": ''
        }, { "data": "_id" }, { "data": "senderName" }, { "data": "receiverName" }, { "data": "searchAddress" }, { "data": "delivered" }],
        "order": [[1, 'asc']]
    });
    ...
    function format(d) {
        ...
        var primaryTable = '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">' + '<tr>' + '<td>보내는 사람 :</td>' + '<td>' + d.senderName + '</td>' + '</tr>' + '<tr>' + '<td>받는 사람:</td>' + '<td>' + d.receiverName + '</td>' + '</tr>' + '<tr>' + '<td>배송지:</td>' + '<td>' + d.searchAddress + d.additionalAddress + d.postCode + '</td>' + '</tr>' + '</table>';
        ...
        for (var i = 0; i < products.length; i++) {
            ...
            primaryTable += '<tr>' + '<td>' + curProduct.name + '</td>' + '<td>' + curProduct.quantity + '</td>' + '</tr>';
        }
